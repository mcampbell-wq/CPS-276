...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'crcrcampbell';//this will be your WCC username
      $dbUsr = 'crcrcampbell';//this will be your WCC username
      $dbPass = 'z8xrNDRU64twW4v';//this will be the password found in the video.
